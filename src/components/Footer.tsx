        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 md:col-span-2 space-y-8">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-brand-blue to-brand-yellow flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform">
            ...
            <div className="flex gap-4">
              {[X, Share2, LinkIcon, GitBranch].map((Icon, i) => (
                <a 
                  key={i} 
                  href="#" 
                  className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-foreground/40 hover:text-brand-yellow hover:border-brand-yellow/30 hover:bg-brand-yellow/5 transition-all group"
                >
          ...
          <div>
            <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-yellow mb-8">{t.footerContactTitle}</h4>
            <ul className="space-y-6">
              <li className="flex items-center gap-4 text-foreground/60 hover:text-brand-yellow transition-colors cursor-pointer group">
          ...
          <div>
            <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-yellow mb-8">Navigation</h4>
        ...
        <div className="pt-12 border-t border-card-border flex flex-col md:flex-row justify-between items-center gap-8">
           <p className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground/20">
            ...
            <div className="flex gap-8 items-center text-[10px] font-black uppercase tracking-[0.2em] text-foreground/20">
               ...
               <span className="hover:text-brand-yellow cursor-pointer transition-colors">Cookie Policy</span>
            </div>
        </div>
      </div>
    </footer>
