...
import { UploadCloud, Zap, Shield, MessageCircle, Boxes, Sparkles, ArrowRight, Play, CheckCircle2, Star, Cpu, Globe } from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <section className="max-w-7xl mx-auto mb-48">
             ...
             <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[800px]">
                ...
                >
                   ...
                   <Link href="/editor" className="group/btn relative px-10 py-5 rounded-2xl bg-white text-black font-black uppercase text-xs tracking-[0.3em] overflow-hidden transition-transform active:scale-95 shrink-0">
          ...
          <section className="mb-48">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                { id: 'tshirts', title: 'T-Shirts', img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&q=80&w=800', span: 'md:col-span-2' },
                { id: 'hoodies', title: 'Hoodies', img: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&q=80&w=800', span: 'md:col-span-1' },
                { id: 'accessories', title: 'Access.', img: 'https://images.unsplash.com/photo-1576053139778-7e32f2ae3cfd?auto=format&fit=crop&q=80&w=800', span: 'md:col-span-1' },
              ].map((item, idx) => (
                <motion.div
                  key={item.id}
                ...
                >
                  <Link 
                    ...
                    className="relative block group h-[500px] overflow-hidden rounded-[3rem] border border-white/5 shadow-2xl"
                  >
                    ...
                    <div className="absolute bottom-10 left-10">
                      <h3 className="text-4xl font-black text-white mb-2 uppercase italic tracking-tighter">{item.title}</h3>
