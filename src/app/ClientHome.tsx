      ...
      <main className="relative pt-32 pb-20">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-30">
          <motion.div 
            ...
            className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-brand-blue/20 rounded-full mix-blend-screen filter blur-[120px]" 
          />
          <motion.div 
            animate={{ scale: [1, 1.1, 1], x: [20, -20, 20], y: [20, -20, 20] }}
            transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
            className="absolute top-[10%] right-[-5%] w-[50%] h-[50%] bg-brand-yellow/10 rounded-full mix-blend-screen filter blur-[120px]" 
          />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-brand-blue/10 border border-brand-blue/20 text-brand-blue text-[10px] font-black uppercase tracking-[0.4em] shadow-2xl shadow-brand-blue/10">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 pt-8 w-full sm:w-auto">
              <Link href="/categories" className="group relative flex items-center justify-center gap-4 px-12 py-6 rounded-2xl font-black text-white bg-brand-blue shadow-[0_20px_50px_rgba(74,144,226,0.4)] hover:shadow-brand-blue/60 hover:-translate-y-1 transition-all duration-500 overflow-hidden">
          ...
          <section className="mb-24">
             <div className="flex flex-col items-center mb-12 text-center space-y-4">
                <span className="text-brand-yellow font-black uppercase tracking-[0.5em] text-[10px]">Collections</span>
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute bottom-10 left-10">
                      ...
                      <div className="flex items-center gap-3 text-brand-yellow font-black uppercase tracking-[0.3em] text-[10px] opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
          ...
          <section className="mb-48">
             <div className="flex flex-col items-center mb-12 text-center space-y-4">
                <span className="text-brand-yellow font-black uppercase tracking-[0.5em] text-[10px]">Studio Items</span>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                {products.slice(0, 4).map((prod) => (
                  <Link key={prod.id} href={`/products/${prod.id}`} className="group block bg-white/5 border border-white/10 rounded-3xl p-4 hover:bg-white/10 transition-colors">
                    ...
                    <p className="text-brand-yellow font-black text-xs">{prod.base_price} MAD</p>
                  </Link>
                ))}
             </div>
          </section>
          ...
          <section className="max-w-7xl mx-auto mb-48">
             <div className="flex flex-col items-center mb-20 text-center space-y-4">
                <span className="text-brand-yellow font-black uppercase tracking-[0.5em] text-[10px]">Architecture</span>
             ...
             <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[800px]">
                ...
                >
                   <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
                   <div className="relative z-10 h-full flex flex-col justify-between">
                      <div>
                        <div className="w-20 h-20 rounded-3xl bg-brand-blue/10 border border-brand-blue/20 flex items-center justify-center mb-10 group-hover:rotate-12 transition-transform duration-500">
                      ...
                      <div className="grid grid-cols-3 gap-6 pt-20 border-t border-white/5">
                         {[
                           ...
                           <div key={stat.label}>
                             <p className="text-[10px] font-black uppercase tracking-widest text-brand-yellow mb-1">{stat.label}</p>
                   ...
                   {/* Decorative Elements */}
                   <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-brand-blue/20 rounded-full blur-[100px] pointer-events-none group-hover:bg-brand-blue/30 transition-colors duration-1000" />
                </motion.div>
          ...
          >
             ...
             <div className="relative z-10 flex flex-col items-center text-center space-y-10">
                <div className="w-24 h-24 rounded-full bg-brand-blue/5 flex items-center justify-center border border-brand-blue/20 group-hover:scale-110 transition-transform duration-700">
                ...
                <Link href="/categories" className="px-16 py-7 rounded-full bg-brand-blue text-white font-black text-xs uppercase tracking-[0.4em] hover:scale-105 active:scale-95 shadow-[0_20px_50px_rgba(74,144,226,0.3)] transition-all duration-500">
                  Initialize Studio
                </Link>
             </div>

             <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-brand-blue/10 rounded-full blur-[120px] group-hover:bg-brand-blue/20 transition-colors duration-1000" />
