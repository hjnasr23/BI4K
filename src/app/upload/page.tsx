...
function UploadContent() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      formData.append("user_id", "00000000-0000-0000-0000-000000000000"); // Placeholder
      ...
      // 2. Create the order (ligne-commande)
      const orderPayload = {
      ...
      const orderResponse = await fetch("http://127.0.0.1:8000/orders/ligne-commande", {
        method: "POST",
      ...
      alert("Success! Your custom order has been placed.");
    } catch (error) {
      console.error(error);
